            ...
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    >
                        {[
                            ...
                            { icon: Code, label: `${repos.length} ${t('stats.repositories')}`, color: "text-blue-600" },
                            { icon: Activity, label: `${Object.keys(languageStats).length} ${t('stats.languages')}`, color: "text-green-600" }
                        ].map((item, index) => (
                            <motion.div
                                key={index}
                ...
                >
                    ...
                    >
                        ...
                        >
                            {[
                                { value: repos.length, label: t('stats.repositories'), color: "blue" },
                                { value: Object.values(commits).reduce((a, b) => a + b, 0), label: t('stats.recentCommits'), color: "green" }
                            ].map((stat, index) => (
                                <motion.div
                                    key={index}
                        ...
                        >
                            {[
                                { value: Object.keys(languageStats).length, label: t('stats.languages'), color: "purple" },
                                { value: repos.reduce((total, repo) => total + repo.stargazers_count, 0), label: t('stats.totalStars'), color: "yellow" }
                            ].map((stat, index) => (
                                <motion.div
                                    key={index}
                                    className={`text-center p-4 bg-gradient-to-br from-${stat.color}-50 to-${stat.color}-100 dark:from-${stat.color}-900/20 dark:to-${stat.color}-800/20 rounded-xl`}
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            {t('sections.languageDistribution')}
                        </motion.h2>
                        <motion.div
                            className="h-80"
                            variants={itemVariants}
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
                        ...
                        <div className="space-y-4 max-h-80 overflow-y-auto">
                            {[
                                ...
                                {
                                    category: t('techStack.cloudDevOps'),
                                    languages: ['AWS', 'Azure', 'Docker', 'Kubernetes', 'Jenkins', 'Git', 'Linux'],
                                    description: t('techStack.cloudDevOpsDesc')
                                },
                                {
                                    category: t('techStack.databases'),
                                    languages: ['MongoDB', 'MySQL', 'PostgreSQL', 'Redis'],
                                    description: t('techStack.databasesDesc')
                                },
                                {
                                    category: t('techStack.testingQuality'),
                                    languages: ['Jest', 'Cypress'],
                                    description: t('techStack.testingQualityDesc')
                                },
                                {
                                    category: t('techStack.toolsOthers'),
                                    languages: ['Nginx', 'RabbitMQ', 'Kibana', 'Bash', 'Shell'],
                                    description: t('techStack.toolsOthersDesc')
                                }
                            ].map((stack, index) => (
