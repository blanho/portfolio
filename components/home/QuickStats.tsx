        ...
        <React.Fragment>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 animate-fadeInUp animation-delay-500">
                <div className="p-3 sm:p-4 rounded-xl bg-white border border-gray-200 shadow-md
                    ...
                    <ThemeText size="sm" className="text-gray-600 dark:text-muted-foreground">{t('years')}</ThemeText>
                </div>
                <div className="p-4 rounded-xl bg-white border border-gray-200 shadow-md
                    ...
                    <ThemeText size="sm" className="text-gray-600 dark:text-muted-foreground">{t('projects')}</ThemeText>
                </div>
                <div className="p-4 rounded-xl bg-white border border-gray-200 shadow-md
                                    dark:bg-card dark:border-border text-center
                                    transform hover:scale-105 hover:-translate-y-1 
                    ...
                    <ThemeText size="sm" className="text-gray-600 dark:text-muted-foreground">{t('quality')}</ThemeText>
                </div>
            </div>
        </React.Fragment>
    )
